...
class UDADecorator(BaseSegmentor):
    ...
    def extract_feat(self, img, sp_image, dates):
        """Extract features from images."""
        return self.get_model().extract_feat(img, sp_image, dates)
    ...
    def forward_train(self,
        ...
        losses = self.get_model().forward_train(
            img, img_metas, gt_semantic_seg, sp_image=sp_image, dates=dates, return_feat=return_feat)
        return losses
    ...
    def simple_test(self, img, img_meta, sp_image=None, dates=None, rescale=True):
        ...
        return self.get_model().simple_test(img, img_meta, sp_image, dates, rescale)
